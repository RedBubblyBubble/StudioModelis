...
export function PricingHighlight() {
  return (
    <SectionShell>
      <MotionReveal>
        <div className="rounded-2xl border border-border-active bg-[linear-gradient(140deg,rgba(53,213,255,0.16),rgba(59,130,246,0.1),rgba(16,25,44,0.96))] p-6 md:p-10">
          <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
            <div className="space-y-4">
              ...
              <div className="flex items-baseline gap-3">
                <span className="font-title text-3xl font-semibold text-fg md:text-6xl">
